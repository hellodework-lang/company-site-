...
export default function Home() {
  ...
  return (
    <main style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)', overflowX: 'clip' }}>
      <Navigation />
      ...
      <section ref={horizontalRef} style={{ height: '800vh', position: 'relative', borderTop: '1px solid var(--border)' }}>
